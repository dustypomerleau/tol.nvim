...
theme.loadUi = function()
    return {
        ...
        StatusLineTermNC = { fg = t.taupe, bg = t.bg_shade1, },
...
theme.loadPlugins = function()
    return {
        ...
        -- DapUIType = { fg = , },
        -- DapUIValue = { fg = , },
        -- DapUIModifiedValue = { fg = , },
        -- DapUIDecoration = { fg = , },
        -- DapUIThread = { fg = , },
        -- DapUIStoppedThread = { fg = , },
        -- DapUIFrameName = { fg = , },
        -- DapUISource = { fg = , },
        -- DapUILineNumber = { fg = , },
        -- DapUIFloatBorder = { fg = , },
        -- DapUIWatchesEmpty = { fg = , },
        -- DapUIWatchesValue = { fg = , },
        -- DapUIWatchesError = { fg = , },
        -- DapUIBreakpointsPath = { fg = , },
        ...
        -- MiniStarterItemBullet = { fg = , },
        -- MiniStarterItemPrefix = { fg = , },
        -- MiniStarterSection = { fg = , },
        -- MiniStarterQuery = { fg = , },

        -- MiniStatuslineDevinfo = { fg = , bg = , },
        -- MiniStatuslineFileinfo = { fg = , bg = , },
        -- MiniStatuslineFilename = { fg = , bg = , },
        -- MiniStatuslineInactive = { fg = , bg = , style = bold, },
        -- MiniStatuslineModeCommand = { fg = , bg = , style = bold, },
        -- MiniStatuslineModeInsert = { fg = , bg = , style = bold, },
        -- MiniStatuslineModeNormal = { fg = , bg = , style = bold, },
        -- MiniStatuslineModeOther = { fg = , bg = , style = bold, },
        -- MiniStatuslineModeReplace = { fg = , bg = , style = bold, },
        -- MiniStatuslineModeVisual = { fg = , bg = , style = bold, },

        -- MiniSurround = { link = "IncSearch", },

        -- MiniTablineCurrent = { bg = , },
        -- MiniTablineFill = { link = "TabLineFill", },
        -- MiniTablineHidden = { bg = , fg = , },
        -- MiniTablineModifiedCurrent = { bg = , fg = , },
        -- MiniTablineModifiedHidden = { bg = , fg = , },
        -- MiniTablineModifiedVisible = { bg = , fg = , },
        -- MiniTablineTabpagesection = { fg = , bg = , style = , },
        -- MiniTablineVisible = { bg = , },

        -- MiniTestEmphasis = { style = bold, },
        -- MiniTestFail = { fg = , style = bold, },
        -- MiniTestPass = { fg = , style = bold, },
